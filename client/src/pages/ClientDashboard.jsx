...
const ClientDashboard = () => {
    ...
    // Data fetch karne ka function alag rakha hai taaki hiring ke baad refresh kar sakein
    ...
    const handleHire = async (gigId, bidId) => {
        ...
        try {
            // Backend route '/gigs/hire' par PATCH request bhej rahe hain
            await API.patch('/gigs/hire', { gigId, bidId });
            alert("Freelancer hired successfully!");
            
            // Hiring ke baad data refresh karein taaki UI update ho jaye
            fetchDashboardData(); 
        } catch (err) {
                 ...
                 <div className="flex-1">
                   <p className="font-bold text-blue-300 text-lg">
                    ...
                    <div className="mt-2 text-xs font-semibold">
                                    ...
                                    <p className="text-gray-500 text-sm italic italic">Abhi tak kisi ne bid nahi lagayi hai.</p>
                                )}
                            </div>
                        </div>
                    ))}
